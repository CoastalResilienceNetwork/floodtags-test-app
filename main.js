...
function ( 	declare, PluginBase, ContentPane, dom, domStyle, domGeom, obj, content, esriapi, clicks, lang ) {
	return declare(PluginBase, {
		...
		toolbarName: "Floodtags Test Application", showServiceLayersInLegend: true, allowIdentifyWhenActive: false, rendered: false, resizable: false,
		...
		initialize: function (frameworkParameters) {
			...
			this.url = "http://tncmaps.eastus.cloudapp.azure.com/arcgis/rest/services/Indonesia/ResilientCitiesTestMap_03072018/MapServer";
			this.layerDefs = [];
		},
		...
		render: function() {
			...
			this.clicks.mapClickFunction(this);
